...
; Function 6: Allocate_Code (var Ptr : Address; Size : Cardinal)
; Function 7: Deallocate_Code (Ptr : Address)
; Function 8: Mark_Code (Start, Limit : Address)
...
Function_Mark_Code:   ; Function 8
	.Start equ dword [ebp + 12]	; Offset : Address
	.Limit equ dword [ebp + 8]	; Limit : Address
