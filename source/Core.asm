; Core.asm - Multithread serialized interface to Core
...
ICore = $100028
; Function 1: Allocate (Size : Card32) : Address
; Function 2: Deallocate (Ptr : Address)
; Function 3: Allocate_code (Size : Card32; Type : Card32) : Address
; Function 4: Deallocate_code (Ptr : Address)

; Function 5: Register_module (Module_id : Card128; Module_address : Address)
; Function 6: New_thread (Entry_point : Address; Stack1_size, Stack2_size : Card32) : Card32
...
Function_Allocate:    ; Function 1
	...
	mov eax, [fs:IMemory + 4]
	mov eax, [fs:eax + IMemory.Allocate]
...
Function_Deallocate:	; Function 2
	...
	mov eax, [fs:IMemory + 4]
	mov eax, [fs:eax + IMemory.Deallocate]
	mov [fs:ebx + Slot_1.Function], eax
...
Function_Allocate_code:    ; Function 3
	...
	mov eax, [fs:IMemory + 4]
	mov eax, [fs:eax + IMemory.Allocate_Code]
...
Function_Deallocate_code:    ; Function 4
	...
	mov eax, [fs:IMemory + 4]
	mov eax, [fs:eax + IMemory.Deallocate_Code]
	mov [fs:ebx + Slot_2.Function], eax
...
Function_Register_module:    ; Function 5
	...
	mov eax, [fs:IModule + 4]
	mov eax, [fs:eax + IModule.Register_Module]
...
Function_Add_address_space:    ; Function 7
	...
	mov eax, [fs:IModule + 4]
	mov eax, [fs:eax + IModule.Add_address_space]
	mov [fs:ebx + Slot_3.Function], eax
